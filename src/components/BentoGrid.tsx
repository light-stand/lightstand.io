        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="flex-1 bg-black/40 rounded-xl p-6 w-full border border-white/5">
                <div className="flex items-center justify-between mb-4 pb-4 border-b border-white/5">
                  ...
                  <span className="text-red-400 flex items-center gap-2"><X className="w-4 h-4" /> 4.2s</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-white font-medium">Lightstand</span>
                  <span className="text-green-400 flex items-center gap-2"><Check className="w-4 h-4" /> 0.1s</span>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="md:col-span-2" delay={0.8}>
             <div className="flex flex-col md:flex-row items-center gap-12">
                <div className="flex-1">
                   <h3 className="text-2xl font-bold mb-4">Google Lighthouse 100/100</h3>
                   <p className="text-zinc-400 leading-relaxed">
